 ...
 * @ingroup qbr
 *
 * The basic layout of any packet in QBR is as follows (omitting IP and
 * UDP headers):
  \verbatim
    0                   1                   2                   3
...
class MessageHeader : public Header
{
  ...
  public:
    ...
    /**
     * A Neighbor Item that bundles address and metrics
     * Allows multiple metrics per neighbor
     */
    struct NeighborItem
    {
        Ipv4Address address;
    ...
    */
    ...
    struct Tc
    {
        std::vector<NeighborItem> advertisedNeighbors; 
